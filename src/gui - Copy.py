...
class R6StatsApp:
    ...
    def map_selection(self):
        ...
        # map_images_dir = "D:\Homework\CIS350\R6Stats\map_pictures"
    ...
    def add_round(self):
        ...
        def add_round_to_match():
            self.round_input.append(round_data)
        ...
        def save_match():
            match_data = []
            for round_data in self.round_inputs:
